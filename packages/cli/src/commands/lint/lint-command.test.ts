...
import type { ActorRecord, FsLintOptions, FsFixOptions, FixReport, LintOptions, LintReport, LintResult } from '@gitgov/core';
...
describe('LintCommand - Complete Unit Tests', () => {
  ...
  describe('CLI Argument Parsing & Module Integration (EARS-A1 to A8)', () => {
  ...
  describe('Output Formatting - Text Mode (EARS-B1 to B2)', () => {
  ...
  describe('Migration Detection Mode (EARS-C1)', () => {
  ...
  describe('Output Formatting - JSON Mode & Exit Codes (EARS-D1 to D3)', () => {
  ...
  describe('Output Summary & Limiting (EARS-E1 to E3)', () => {
